...
public final class Constants {
  ...
  public static final double INCHES_IN_TICKS = (1 / CIRCUMFERENCE) * 4096;
  // Multiply INCHES_IN_TICKS by Auto-Drive distance in inches (make a new variable for distance)
