  ...
  public DriveSubsystem() {
    ...
    switch(motorType){
      case SPARKS:
        ...
        break;
      case FALCONS:
        falconFrontRightDrive = new TalonFX(TALON_FRONT_RIGHT_DRIVE_PORT);
        falconFrontLeftDrive = new TalonFX(TALON_FRONT_LEFT_DRIVE_PORT);
        falconBackRightDrive = new TalonFX(TALON_BACK_RIGHT_DRIVE_PORT);
        falconBackLeftDrive = new TalonFX(TALON_BACK_LEFT_DRIVE_PORT);
        break;
      case VICTORS:
